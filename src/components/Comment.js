...
function Comment(props) {
  ...
  const subtract = () => {
    scores > 0 && setScores((prev) => prev - 1);
  };
  ...
  useEffect(() => {
    ...
    if (comment !== null) setVal(comment);
  }, []);
      ...
      <div>
        <div className="align-middle bg-white mt-6 p-6 flex desktop:flex-row mobile:flex-col-reverse rounded-md desktop:mx-44 desktop:mr-64 mobile:mx-5 mobile:mr-4">
          <div className="bg-light-grayish-blue desktop:mt-0 mobile:mt-4 desktop:w-10 desktop:h-24 mobile:w-24 mobile:h-10 align-middle flex desktop:flex-col mobile:flex-row justify-center px-3 pr-5 py-3 rounded-md">
            ...
            <p className="desktop:py-4 desktop:px-0 mobile:px-4 text-moderate-blue font-bold">
              {scores}
            </p>
            <label
              ...
              <div>
                <div className="flex">
                  <div>
                    {" "}
                    <label>
                      <img className="w-9" src={props.image} alt="avatars" />{" "}
                    </label>
                  </div>
            ...
            <div className="bg-white mt-6 p-6 flex desktop:flex-row mobile:flex-col-reverse rounded-md desktop:mx-44 desktop:mr-64 mobile:mx-5 mobile:mr-4">
              ...
              <div className="desktop:ml-5 mobile:ml-0 flex-row w-full">
                <form onSubmit={handleSubmit}>
                  ...
                  />
                  <button
                    className="bg-moderate-blue desktop:ml-9 mobile:ml-52 desktop:mb-0 mobile:-mb-10 px-5 py-2 rounded-lg text-white desktop:align-top mobile:align-bottom"
                    type="submit"
                  >
                    REPLY
                  </button>
                ...
                cont.subId === props.id && (
                  <div key={cont.id}>
                    ...
                    {modalOpen && id === cont.id && (
                      <div className="none bg-bg-opacity fixed w-full h-full top-0 left-0 overflow-hidden z-10">
          ...
          {edit && (
            <div className="bg-white mt-6 p-6 flex-row rounded-md desktop:mx-44 desktop:mr-64 desktop:ml-64 mobile:ml-9 mobile:mx-5 mobile:mr-4">
              <form onSubmit={handleSubmit}>
                ...
                />
                <button
                  className="bg-moderate-blue desktop:ml-4 mobile:ml-44 desktop:mt-0 mobile:mt-2 px-5 py-2 rounded-lg text-white align-top"
                  type="submit"
                >
                  UPDATE
                </button>
