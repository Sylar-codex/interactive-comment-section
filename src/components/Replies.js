            ...
            <div>
                ...
                <div className="align-middle bg-white mt-6 p-6 flex desktop:flex-row mobile:flex-col-reverse rounded-md desktop:mx-44 desktop:ml-64 mobile:ml-9 desktop:mr-64 mobile:mx-5 mobile:mr-4">
                    <div className="bg-light-grayish-blue desktop:mt-0 mobile:mt-4 desktop:w-10 desktop:h-24 mobile:w-24 mobile:h-10 align-middle flex desktop:flex-col mobile:flex-row justify-center px-3 pr-5 py-3 rounded-md" >
                        ...
                        <div className='desktop:py-4 desktop:px-0 mobile:px-4 text-moderate-blue font-bold'>{score}</div>
                        <div className='desktop:w-2 desktop:mt-0 mobile:mt-2 h-auto min-w-fit hover:cursor-pointer' onClick={() => { subtraction() }}> <img src={minus} alt="minus" /></div>
                    </div>
                    <div className='w-full desktop:ml-5 mobile:ml-0'>
                        <div className='flex justify-between desktop:flex-row mobile:flex-col'>
                            <div>
                                <div className='flex'>
                                    <div> <img className='desktop:w-9 mobile:w-6' src={props.image} alt="Avatar" /></div>
                                ...
                                <div className='mt-5'>
                                    <p className='desktop:text-xl mobile:text-md'><span className='font-bold text-moderate-blue'>@{props.replyTo}</span> {props.content} </p>
                                </div>
                            </div>
                            <div onClick={() => { onReply(props.id) }} className='flex desktop:ml-0 desktop:mb-0 desktop:mt-0 mobile:ml-56 mobile:-mb-12 mobile:mt-10 hover:cursor-pointer'>
                ...
                <div>
                    <div>
                        {reply && props.id === id && <div className="bg-white mt-6 p-6 flex desktop:flex-row mobile:flex-col-reverse rounded-md desktop:mx-44 desktop:mr-64 desktop:ml-64 mobile:ml-9 mobile:mx-5 mobile:mr-4">
                            ...
                            <div className='desktop:ml-5 mobile:ml-0 flex-row w-full'>
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <textarea onChange={handleChange} className='border-2 resize-none hover:border-light-gray border-very-light-gray outline-none desktop:w-10/12 mobile:w-full h-24 pb-14 pl-3 rounded-lg' name='' value={Value} placeholder='leave a reply...' />
                                    <button className='bg-moderate-blue desktop:ml-5 mobile:ml-48 desktop:mb-0 mobile:-mb-10  px-5 py-2 rounded-lg text-white mobile:align-bottom desktop:align-top' type='submit'>REPLY</button>
                ...
                <div>
                    {
                        edit && <div className="bg-white mt-6 p-6 flex-row rounded-md desktop:mx-44 desktop:mr-64 desktop:ml-64 mobile:ml-9 mobile:mx-5 mobile:mr-4">
                            <form onSubmit={handleSubmit}>
                                ...
                                <button className='bg-moderate-blue desktop:mt-0 mobile:mt-2 desktop:ml-4 mobile:ml-44 px-5 py-2 rounded-lg text-white align-top' type='submit'>UPDATE</button>
